...
const VenusPosition = require('../src/planets/Venus');
...
describe('#VenusPosition', () => {
  describe('Verify', () => {
    it('天文算法 例31.a', () => {
      let venus = new VenusPosition({ time: new JDateRepository(2448976.5, 'jde') });
      let sc = venus.get().sc;
      ...
      venus.withLightTimeEffect = true;
      let sc2 = venus.get().sc;
